...
class Game {
  ...
  levelKey(){ // stores all the level grids
    ...
    if(this.gameStateID === 4){
      this.levelRender(level1Key);
    } else if(this.gameStateID === 5) {
      this.levelRender(level2Key);
    } else if(this.gameStateID === 6){
      this.levelRender(level3Key);  
    } else if(this.gameStateID === 7){
      this.levelRender(level4Key);
    } else if(this.gameStateID === 8){
      this.levelRender(level5Key);
    }
  }
